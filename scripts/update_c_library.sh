...
# cd /tmp; git clone git@github.com:skye-git/mavlink.git &> /dev/null; \
# cd /tmp/mavlink && git remote rename origin upstream &> /dev/null; \
# mkdir -p include/mavlink/v1.0 && cd include/mavlink/v1.0 && git clone git@github.com:skye-git/c_library.git &> /dev/null; \
...
MAVLINK_GIT_BRANCHNAME=skye_pixracer_porting
CLIBRARY_PATH=$MAVLINK_PATH/include/mavlink/v1.0/c_library
CLIBRARY_GIT_REMOTENAME=origin
CLIBRARY_GIT_BRANCHNAME=skye_pixracer_porting
